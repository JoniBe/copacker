...
namespace copacker.Controllers
{
    public class MesasController : Controller
    {
        ...
        {
            return View(await db.Mesas.ToListAsync());
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "idMesa,Descripcion")] Mesa mesa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "idMesa,Descripcion")] Mesa mesa)
        {
            if (ModelState.IsValid)
            {
